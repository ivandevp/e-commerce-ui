...
module.exports = {"hero":"hero__31Obu"};
			...
			Object(preact_min["h"])(
				...
				sections.map(function (section) {
					return Object(preact_min["h"])(
						...
						Object(preact_min["h"])(
							match["Link"],
							{ activeClassName: header_style_default.a.active, href: '/' + getPath(section.id) },
							section.label
						)
					);
				})
...
var hero_HeroImage = function HeroImage() {
    return Object(preact_min["h"])(
        'div',
        { 'class': hero_style_default.a.hero },
        Object(preact_min["h"])(
            'div',
            { 'class': hero_style_default.a.message },
            hero__ref,
            hero__ref2
        )
    );
...
/* harmony default export */ var hero = (hero_HeroImage);
...
var home__ref = Object(preact_min["h"])(hero, null);
